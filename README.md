...
Current application release: **1.1.14**. Increase the final number once per subsequent delivered update (1.1.15, 1.1.16, …); see `AGENTS.md`. The JSON schema version remains independent.
