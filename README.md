...
Current application release: **1.1.8**. Increase the final number once per subsequent delivered update (1.1.9, 1.1.10, …); see `AGENTS.md`. The JSON schema version remains independent.
