...
Object.assign(messages,{"Kartenarchiv nicht erreichbar. Dein aktueller Plan bleibt erhalten.": ["Map archive unavailable. Your current plan is preserved.", "Archive indisponible. Votre plan actuel est conservé.", "Archivo no disponible. Tu plano actual se conserva.", "Arquivo indisponível. O plano atual é mantido.", "Không truy cập được kho bản đồ. Bản đồ hiện tại vẫn được giữ.", "지도 보관함에 연결할 수 없습니다. 현재 계획은 유지됩니다."], "Noch keine gespeicherten Karten.": ["No saved maps yet.", "Aucune carte enregistrée.", "Todavía no hay mapas guardados.", "Ainda não há mapas salvos.", "Chưa có bản đồ đã lưu.", "저장된 지도가 없습니다."], "Karte geladen.": ["Map loaded.", "Carte chargée.", "Mapa cargado.", "Mapa carregado.", "Đã tải bản đồ.", "지도를 불러왔습니다."], "Karte löschen?": ["Delete map?", "Supprimer la carte ?", "¿Eliminar mapa?", "Excluir mapa?", "Xóa bản đồ?", "지도를 삭제할까요?"], "Die gespeicherte Karte und ihr Viewer-Link werden entfernt. Der geöffnete Plan bleibt erhalten.": ["The saved map and its viewer link will be removed. The open plan is preserved.", "La carte enregistrée et son lien seront supprimés. Le plan ouvert est conservé.", "Se eliminarán el mapa guardado y su enlace. El plano abierto se conserva.", "O mapa salvo e seu link serão removidos. O plano aberto será mantido.", "Bản đồ đã lưu và liên kết xem sẽ bị xóa. Bản đồ đang mở vẫn được giữ.", "저장된 지도와 보기 링크가 삭제됩니다. 현재 열린 계획은 유지됩니다."], "Karte gelöscht.": ["Map deleted.", "Carte supprimée.", "Mapa eliminado.", "Mapa excluído.", "Đã xóa bản đồ.", "지도가 삭제되었습니다."], "Bitte einen Kartennamen eingeben.": ["Enter a map name.", "Saisissez un nom de carte.", "Introduce un nombre para el mapa.", "Digite um nome para o mapa.", "Nhập tên bản đồ.", "지도 이름을 입력하세요."], "Karte gespeichert.": ["Map saved.", "Carte enregistrée.", "Mapa guardado.", "Mapa salvo.", "Đã lưu bản đồ.", "지도를 저장했습니다."], "Viewer wird vorbereitet …": ["Preparing viewer …", "Préparation de la vue …", "Preparando visor…", "Preparando visualizador…", "Đang chuẩn bị chế độ xem…", "보기 화면 준비 중…"], "Viewer-Link bereit. Jeder mit diesem Link kann die Karte sehen.": ["Viewer link ready. Anyone with this link can view the map.", "Lien prêt. Toute personne disposant du lien peut voir la carte.", "Enlace listo. Cualquiera con este enlace puede ver el mapa.", "Link pronto. Qualquer pessoa com este link pode ver o mapa.", "Liên kết đã sẵn sàng. Ai có liên kết đều có thể xem bản đồ.", "링크가 준비되었습니다. 링크가 있는 사람은 지도를 볼 수 있습니다."], "Link kopiert.": ["Link copied.", "Lien copié.", "Enlace copiado.", "Link copiado.", "Đã sao chép liên kết.", "링크를 복사했습니다."], "Link markieren und kopieren.": ["Select and copy the link.", "Sélectionnez et copiez le lien.", "Selecciona y copia el enlace.", "Selecione e copie o link.", "Chọn và sao chép liên kết.", "링크를 선택하여 복사하세요."], "Ungültige Archiv-Schlüsseldatei.": ["Invalid archive key file.", "Fichier de clé non valide.", "Archivo de clave no válido.", "Arquivo de chave inválido.", "Tệp khóa kho lưu trữ không hợp lệ.", "보관함 키 파일이 올바르지 않습니다."], "Archiv wechseln?": ["Switch archive?", "Changer d’archive ?", "¿Cambiar de archivo?", "Trocar arquivo?", "Đổi kho lưu trữ?", "보관함을 변경할까요?"], "Sichere zuerst deinen bisherigen Archiv-Schlüssel. Der geöffnete Plan bleibt erhalten.": ["Back up your current archive key first. The open plan is preserved.", "Sauvegardez d’abord votre clé actuelle. Le plan ouvert est conservé.", "Guarda primero tu clave actual. El plano abierto se conserva.", "Salve primeiro sua chave atual. O plano aberto é mantido.", "Hãy sao lưu khóa hiện tại trước. Bản đồ đang mở vẫn được giữ.", "먼저 현재 보관함 키를 백업하세요. 열린 계획은 유지됩니다."], "Online gespeicherte Karten. Eine Karte enthält alle 21 Varianten.": ["Maps saved online. Each map includes all 21 variants.", "Cartes enregistrées en ligne. Chaque carte contient les 21 variantes.", "Mapas guardados en línea. Cada mapa incluye las 21 variantes.", "Mapas salvos online. Cada mapa inclui as 21 variantes.", "Bản đồ lưu trực tuyến. Mỗi bản đồ gồm cả 21 biến thể.", "온라인 저장 지도입니다. 각 지도에 21개 변형이 모두 포함됩니다."], "Terrainfarbe": ["Terrain color", "Couleur du terrain", "Color del terreno", "Cor do terreno", "Màu địa hình", "지형 색상"], "Schlamm {size} × {size}: bebaubar. Fester Kern {core} × {core}.": ["Mud {size} × {size}: buildable. Solid core {core} × {core}.", "Boue {size} × {size} : constructible. Noyau fixe {core} × {core}.", "Barro {size} × {size}: edificable. Núcleo fijo {core} × {core}.", "Lama {size} × {size}: construível. Núcleo fixo {core} × {core}.", "Bùn {size} × {size}: có thể xây. Lõi cố định {core} × {core}.", "진흙 {size} × {size}: 배치 가능. 고정 중심부 {core} × {core}."], "Gespeicherte Karte laden?": ["Load saved map?", "Charger la carte enregistrée ?", "¿Cargar mapa guardado?", "Carregar mapa salvo?", "Tải bản đồ đã lưu?", "저장된 지도를 불러올까요?"], "Nicht gespeicherte Änderungen werden ersetzt.": ["Unsaved changes will be replaced.", "Les modifications non enregistrées seront remplacées.", "Se reemplazarán los cambios sin guardar.", "Alterações não salvas serão substituídas.", "Các thay đổi chưa lưu sẽ bị thay thế.", "저장하지 않은 변경 사항은 덮어씁니다."], "Ungültige Terrainfarbe.": ["Invalid terrain color.", "Couleur de terrain non valide.", "Color de terreno no válido.", "Cor de terreno inválida.", "Màu địa hình không hợp lệ.", "지형 색상이 올바르지 않습니다."], "Stronghold": ["Stronghold", "Bastion", "Bastión", "Fortaleza", "Cứ điểm", "거점"], "Stadt": ["City", "Ville", "Ciudad", "Cidade", "Thành phố", "도시"], "Meine Karten": ["My maps", "Mes cartes", "Mis mapas", "Meus mapas", "Bản đồ của tôi", "내 지도"], "Kartenname": ["Map name", "Nom de la carte", "Nombre del mapa", "Nome do mapa", "Tên bản đồ", "지도 이름"], "Karte speichern": ["Save map", "Enregistrer la carte", "Guardar mapa", "Salvar mapa", "Lưu bản đồ", "지도 저장"], "Als neue Karte": ["Save as new", "Nouvelle copie", "Guardar como nuevo", "Salvar como novo", "Lưu thành bản mới", "새 지도로 저장"], "Viewer öffnen / teilen": ["Open / share viewer", "Ouvrir / partager la vue", "Abrir / compartir visor", "Abrir / compartilhar visualizador", "Mở / chia sẻ chế độ xem", "보기 열기 / 공유"], "Link kopieren": ["Copy link", "Copier le lien", "Copiar enlace", "Copiar link", "Sao chép liên kết", "링크 복사"], "Liste aktualisieren": ["Refresh list", "Actualiser la liste", "Actualizar lista", "Atualizar lista", "Làm mới danh sách", "목록 새로고침"], "Archiv-Zugang sichern": ["Back up archive access", "Sauvegarder l’accès aux cartes", "Guardar acceso al archivo", "Salvar acesso ao arquivo", "Sao lưu quyền truy cập", "보관함 접근 백업"], "Mit dieser Schlüsseldatei kannst du deine Karten in einem anderen Browser öffnen. Nicht an Besucher weitergeben.": ["Use this key file to open your maps in another browser. Do not share it with viewers.", "Ce fichier permet d’ouvrir vos cartes dans un autre navigateur. Ne le partagez pas avec les visiteurs.", "Este archivo permite abrir tus mapas en otro navegador. No lo compartas con visitantes.", "Use este arquivo para abrir os mapas em outro navegador. Não compartilhe com visitantes.", "Dùng tệp khóa này để mở bản đồ ở trình duyệt khác. Không chia sẻ với người xem.", "이 키 파일로 다른 브라우저에서 지도를 열 수 있습니다. 방문자에게 공유하지 마세요."], "Schlüssel sichern": ["Back up key", "Sauvegarder la clé", "Guardar clave", "Salvar chave", "Sao lưu khóa", "키 백업"], "Schlüssel laden": ["Load key", "Charger la clé", "Cargar clave", "Carregar chave", "Tải khóa", "키 불러오기"], "{n} Spieler gefunden.": ["{n} players found.", "{n} joueurs trouvés.", "{n} jugadores encontrados.", "{n} jogadores encontrados.", "Tìm thấy {n} người chơi.", "플레이어 {n}명 검색됨."], "Öffne den Viewer-Link aus deiner Allianz.": ["Open the viewer link from your alliance.", "Ouvrez le lien partagé par votre alliance.", "Abre el enlace de tu alianza.", "Abra o link da sua aliança.", "Mở liên kết xem từ liên minh của bạn.", "연맹에서 공유한 보기 링크를 여세요."], "Karte wird geladen …": ["Loading map …", "Chargement de la carte…", "Cargando mapa…", "Carregando mapa…", "Đang tải bản đồ…", "지도 불러오는 중…"], "Stand: {date}": ["Updated: {date}", "Mise à jour : {date}", "Actualizado: {date}", "Atualizado: {date}", "Cập nhật: {date}", "업데이트: {date}"], "Karte konnte nicht geladen werden.": ["Could not load map.", "Impossible de charger la carte.", "No se pudo cargar el mapa.", "Não foi possível carregar o mapa.", "Không thể tải bản đồ.", "지도를 불러올 수 없습니다."], "Nur ansehen": ["View only", "Lecture seule", "Solo lectura", "Somente leitura", "Chỉ xem", "보기 전용"], "Aktualisieren": ["Refresh", "Actualiser", "Actualizar", "Atualizar", "Làm mới", "새로고침"], "Die Plan-Datei ist zu groß.": ["Plan file is too large.", "Le fichier est trop volumineux.", "El archivo es demasiado grande.", "O arquivo é muito grande.", "Tệp bản đồ quá lớn.", "계획 파일이 너무 큽니다."], "Ungültige Plan-Datei.": ["Invalid plan file.", "Fichier de plan non valide.", "Archivo de plano no válido.", "Arquivo de plano inválido.", "Tệp bản đồ không hợp lệ.", "계획 파일이 올바르지 않습니다."], "Archiv-Zugang fehlt.": ["Archive access is missing.", "Accès à l’archive manquant.", "Falta acceso al archivo.", "Falta acesso ao arquivo.", "Thiếu quyền truy cập kho lưu trữ.", "보관함 접근 키가 없습니다."], "Nur Lesen erlaubt.": ["Read only.", "Lecture seule.", "Solo lectura.", "Somente leitura.", "Chỉ được xem.", "읽기만 허용됩니다."], "Karte nicht gefunden.": ["Map not found.", "Carte introuvable.", "Mapa no encontrado.", "Mapa não encontrado.", "Không tìm thấy bản đồ.", "지도를 찾을 수 없습니다."], "Nicht erlaubt.": ["Not allowed.", "Non autorisé.", "No permitido.", "Não permitido.", "Không được phép.", "허용되지 않습니다."], "Die Karte wurde inzwischen geändert. Bitte neu laden oder als neue Karte speichern.": ["The map changed elsewhere. Reload it or save as a new map.", "La carte a été modifiée ailleurs. Rechargez-la ou enregistrez une nouvelle carte.", "El mapa cambió en otra sesión. Recárgalo o guárdalo como nuevo.", "O mapa mudou em outra sessão. Recarregue ou salve como novo.", "Bản đồ đã thay đổi ở nơi khác. Tải lại hoặc lưu thành bản mới.", "다른 곳에서 지도가 변경되었습니다. 다시 불러오거나 새 지도로 저장하세요."], "Viewer-Link konnte nicht erstellt werden.": ["Could not create viewer link.", "Impossible de créer le lien.", "No se pudo crear el enlace.", "Não foi possível criar o link.", "Không thể tạo liên kết xem.", "보기 링크를 만들 수 없습니다."], "Laden": ["Load", "Charger", "Cargar", "Carregar", "Tải", "불러오기"], "Löschen": ["Delete", "Supprimer", "Eliminar", "Excluir", "Xóa", "삭제"], "Viewer": ["Viewer", "Vue", "Visor", "Visualizador", "Chế độ xem", "뷰어"]});
Object.assign(messages,{"Missile": ["Missile", "Missile", "Misil", "Míssil", "Tên lửa", "미사일"], "Missile-Bereich": ["Missile area", "Zone du missile", "Área del misil", "Área do míssil", "Vùng tên lửa", "미사일 범위"], "Äußere Schlammfläche": ["Outer mud area", "Zone de boue extérieure", "Área exterior de barro", "Área externa de lama", "Vùng bùn bên ngoài", "외곽 진흙 구역"], "Fester Kern": ["Solid core", "Noyau solide", "Núcleo sólido", "Núcleo sólido", "Lõi cố định", "고정 중심부"], "Größe angepasst.": ["Size updated.", "Dimensions modifiées.", "Tamaño actualizado.", "Tamanho atualizado.", "Đã cập nhật kích thước.", "크기가 변경되었습니다."], "Der feste Kern muss innerhalb der Außenfläche liegen.": ["The solid core must fit inside the outer area.", "Le noyau solide doit tenir dans la zone extérieure.", "El núcleo sólido debe caber dentro del área exterior.", "O núcleo sólido deve caber dentro da área externa.", "Lõi cố định phải nằm trong vùng bên ngoài.", "고정 중심부는 외곽 영역 안에 들어가야 합니다."], "Die linke untere Ecke bleibt bei Größenänderungen über diese Felder fest.": ["Resizing with these fields keeps the bottom-left corner fixed.", "Le redimensionnement avec ces champs conserve le coin inférieur gauche.", "Al cambiar el tamaño con estos campos, la esquina inferior izquierda permanece fija.", "Ao redimensionar por estes campos, o canto inferior esquerdo permanece fixo.", "Đổi kích thước bằng các ô này sẽ giữ nguyên góc dưới bên trái.", "이 입력란으로 크기를 변경하면 왼쪽 아래 모서리는 고정됩니다."], "Der Kern liegt auf ganzen Feldern möglichst mittig. Nur der Kern blockiert Gebäude.": ["The core is centered as closely as whole tiles allow. Only the core blocks buildings.", "Le noyau est centré autant que le permettent les cases entières. Seul le noyau bloque les bâtiments.", "El núcleo se centra lo mejor posible en casillas enteras. Solo el núcleo bloquea edificios.", "O núcleo fica o mais centralizado possível em quadrados inteiros. Apenas o núcleo bloqueia edifícios.", "Lõi được đặt gần giữa nhất có thể trên các ô nguyên. Chỉ lõi mới chặn công trình.", "중심부는 정수 칸 기준으로 최대한 중앙에 배치됩니다. 중심부만 건물 배치를 막습니다."], "Rote Markierung ohne Kollisionen. Andere Objekte bleiben frei platzierbar.": ["Red marker without collisions. Other objects can still be placed freely.", "Marquage rouge sans collision. Les autres objets restent librement positionnables.", "Marca roja sin colisiones. Los demás objetos se pueden colocar libremente.", "Marcação vermelha sem colisões. Outros objetos continuam livres para posicionamento.", "Vùng đánh dấu màu đỏ không gây va chạm. Các đối tượng khác vẫn có thể đặt tự do.", "충돌이 없는 빨간 표시입니다. 다른 객체를 자유롭게 배치할 수 있습니다."]});
Object.assign(messages,{"Warnsymbol ziehen, um die Raketenfläche zu verschieben.": ["Drag the warning symbol to move the missile area.", "Faites glisser le symbole d’alerte pour déplacer la zone du missile.", "Arrastra el símbolo de advertencia para mover el área del misil.", "Arraste o símbolo de aviso para mover a área do míssil.", "Kéo biểu tượng cảnh báo để di chuyển vùng tên lửa.", "경고 기호를 드래그하여 미사일 범위를 이동하세요."], "Raketen ausprobieren": ["Try missile positions", "Tester les positions des missiles", "Probar posiciones de misiles", "Testar posições dos mísseis", "Thử vị trí tên lửa", "미사일 위치 시험"], "Ziehe das Warnsymbol in der Mitte. Änderungen gelten nur für deine Ansicht und werden nicht gespeichert.": ["Drag the warning symbol in the center. Changes affect only your view and are not saved.", "Faites glisser le symbole d’alerte au centre. Les changements ne concernent que votre vue et ne sont pas enregistrés.", "Arrastra el símbolo de advertencia del centro. Los cambios solo afectan a tu vista y no se guardan.", "Arraste o símbolo de aviso no centro. As alterações afetam apenas a sua visualização e não são salvas.", "Kéo biểu tượng cảnh báo ở giữa. Thay đổi chỉ áp dụng cho chế độ xem của bạn và không được lưu.", "중앙의 경고 기호를 드래그하세요. 변경 사항은 내 화면에만 적용되며 저장되지 않습니다."], "Raketen zurücksetzen": ["Reset missiles", "Réinitialiser les missiles", "Restablecer misiles", "Redefinir mísseis", "Đặt lại tên lửa", "미사일 초기화"], "Raketenfläche verschieben: ziehen oder Pfeiltasten verwenden.": ["Move missile area: drag or use arrow keys.", "Déplacer la zone du missile : glisser ou utiliser les flèches du clavier.", "Mover área del misil: arrastra o usa las teclas de flecha.", "Mover área do míssil: arraste ou use as teclas de seta.", "Di chuyển vùng tên lửa: kéo hoặc dùng phím mũi tên.", "미사일 범위 이동: 드래그하거나 방향키를 사용하세요."]});
Object.assign(messages,{"Theme": ["Theme", "Thème", "Tema", "Tema", "Giao diện", "테마"], "Nacht": ["Night", "Nuit", "Noche", "Noite", "Đêm", "밤"], "Himmel": ["Sky", "Ciel", "Cielo", "Céu", "Bầu trời", "하늘"], "Sand": ["Sand", "Sable", "Arena", "Areia", "Cát", "모래"], "Salbei": ["Sage", "Sauge", "Salvia", "Sálvia", "Xanh dịu", "세이지"]});
Object.assign(messages,{"Objektzentrum": ["Object center", "Centre de l’objet", "Centro del objeto", "Centro do objeto", "Tâm đối tượng", "객체 중심"], "X/Y beziehen sich auf das Zentrum. Das gesamte Objekt bleibt innerhalb der Karte.": ["X/Y refer to the center. The entire object stays within the map.", "X/Y indiquent le centre. L’objet entier reste dans la carte.", "X/Y indican el centro. Todo el objeto permanece dentro del mapa.", "X/Y indicam o centro. O objeto inteiro permanece dentro do mapa.", "X/Y là tọa độ tâm. Toàn bộ đối tượng phải nằm trong bản đồ.", "X/Y는 중심 좌표입니다. 객체 전체가 지도 안에 있어야 합니다."], "Kein eindeutiges mittleres Feld: Bitte X/Y manuell eintragen. Bei gerader Größe verwenden wir das mittlere Feld links bzw. unten.": ["No single center tile: enter X/Y manually. For even sizes, we use the left or bottom middle tile.", "Pas de case centrale unique : saisissez X/Y. Pour une taille paire, la case médiane gauche ou inférieure sert de référence.", "No hay una casilla central única: introduce X/Y. Con tamaños pares se usa la casilla central izquierda o inferior.", "Não há um quadrado central único: insira X/Y. Em tamanhos pares, usamos o quadrado central à esquerda ou abaixo.", "Không có ô giữa duy nhất: nhập X/Y thủ công. Với kích thước chẵn, dùng ô giữa bên trái hoặc phía dưới.", "중앙 칸이 하나가 아닙니다. X/Y를 직접 입력하세요. 짝수 크기에서는 가운데 왼쪽 또는 아래쪽 칸을 사용합니다."], "Bei verbundenem Terrain beziehen sich die Koordinaten auf das Zentrum des äußeren Rahmens.": ["For connected terrain, coordinates refer to the center of its outer bounds.", "Pour un terrain relié, les coordonnées indiquent le centre du cadre extérieur.", "En terrenos unidos, las coordenadas indican el centro del marco exterior.", "Em terrenos conectados, as coordenadas indicam o centro do contorno externo.", "Với địa hình nối liền, tọa độ chỉ tâm của khung bao ngoài.", "연결된 지형의 좌표는 전체 외곽 영역의 중심입니다."], "Eigener Basisname. Leer lassen, um Spielername oder Platznummer anzuzeigen.": ["Custom base name. Leave blank to show the player name or seat number.", "Nom personnalisé de la base. Laissez vide pour afficher le joueur ou le numéro de place.", "Nombre personalizado de la base. Déjalo vacío para mostrar el jugador o número de plaza.", "Nome personalizado da base. Deixe vazio para mostrar o jogador ou número da posição.", "Tên căn cứ tùy chọn. Để trống để hiển thị tên người chơi hoặc số vị trí.", "기지의 별도 이름입니다. 비워두면 플레이어 이름이나 자리 번호가 표시됩니다."], "Terrain platziert. Größe und Zentrum kannst du rechts einstellen.": ["Terrain placed. Set its size and center on the right.", "Terrain placé. Réglez sa taille et son centre à droite.", "Terreno colocado. Ajusta su tamaño y centro a la derecha.", "Terreno colocado. Ajuste o tamanho e o centro à direita.", "Đã đặt địa hình. Chỉnh kích thước và tâm ở bên phải.", "지형을 배치했습니다. 오른쪽에서 크기와 중심을 설정하세요."], "Kartenkoordinaten des Zentrums": ["Map coordinates of the center", "Coordonnées du centre sur la carte", "Coordenadas del centro en el mapa", "Coordenadas do centro no mapa", "Tọa độ tâm trên bản đồ", "지도상의 중심 좌표"], "Wähle ein Objekt und gib rechts seine Zentrumskoordinaten ein. „Ausgewählte Allianz ausrichten“ verschiebt die Allianz gemeinsam. Die Welt umfasst 1000 × 1000 Felder (0–999).": ["Select an object and enter its center coordinates on the right. Align selected alliance moves its objects together. The world is 1000 × 1000 tiles (0–999).", "Sélectionnez un objet et saisissez son centre à droite. Aligner l’alliance sélectionnée déplace ses objets ensemble. La carte fait 1000 × 1000 cases (0–999).", "Selecciona un objeto e introduce su centro a la derecha. Alinear alianza seleccionada mueve sus objetos juntos. El mapa tiene 1000 × 1000 casillas (0–999).", "Selecione um objeto e insira seu centro à direita. Alinhar aliança selecionada move seus objetos juntos. O mapa tem 1000 × 1000 quadrados (0–999).", "Chọn đối tượng và nhập tọa độ tâm ở bên phải. Căn chỉnh liên minh đã chọn sẽ di chuyển các đối tượng cùng nhau. Bản đồ có 1000 × 1000 ô (0–999).", "객체를 선택하고 오른쪽에 중심 좌표를 입력하세요. 선택한 연맹 정렬은 해당 객체들을 함께 이동합니다. 지도는 1000 × 1000칸(0–999)입니다."], "Terrain auswählen: Rechts lassen sich Größe und Zentrumskoordinaten einstellen. Größenänderungen halten die linke untere bzw. gegenüberliegende Ecke fest. Terrainstücke gemeinsam markieren und mit „Terrain verbinden“ zusammenfügen.": ["Select terrain to set its size and center on the right. Resizing keeps the bottom-left or opposite corner fixed. Select terrain pieces together and choose Connect terrain to join them.", "Sélectionnez un terrain pour régler sa taille et son centre à droite. Le redimensionnement garde le coin inférieur gauche ou opposé fixe. Sélectionnez les morceaux et utilisez Relier les terrains.", "Selecciona terreno para ajustar tamaño y centro a la derecha. Al redimensionar se fija la esquina inferior izquierda u opuesta. Selecciona piezas y usa Unir terrenos.", "Selecione o terreno para ajustar tamanho e centro à direita. Ao redimensionar, o canto inferior esquerdo ou oposto fica fixo. Selecione partes e use Conectar terrenos.", "Chọn địa hình để chỉnh kích thước và tâm ở bên phải. Đổi kích thước giữ cố định góc dưới trái hoặc góc đối diện. Chọn nhiều mảnh và dùng Nối địa hình.", "지형을 선택해 오른쪽에서 크기와 중심을 설정하세요. 크기 변경 시 왼쪽 아래 또는 반대쪽 모서리가 고정됩니다. 여러 지형을 선택하고 지형 연결을 사용하세요."], "Basis 3 × 3 · Zentrum 9 × 9 · Koordinaten: Objektzentrum · Welt 1000 × 1000": ["Base 3 × 3 · Center 9 × 9 · Coordinates: object center · World 1000 × 1000", "Base 3 × 3 · Centre 9 × 9 · Coordonnées : centre · Monde 1000 × 1000", "Base 3 × 3 · Centro 9 × 9 · Coordenadas: centro · Mundo 1000 × 1000", "Base 3 × 3 · Centro 9 × 9 · Coordenadas: centro · Mundo 1000 × 1000", "Căn cứ 3 × 3 · Trung tâm 9 × 9 · Tọa độ: tâm · Bản đồ 1000 × 1000", "기지 3 × 3 · 센터 9 × 9 · 좌표: 중심 · 지도 1000 × 1000"], "Basis 3 × 3 · Marshall 3 × 3 · Koordinaten: Objektzentrum · Welt 1000 × 1000": ["Base 3 × 3 · Marshall 3 × 3 · Coordinates: object center · World 1000 × 1000", "Base 3 × 3 · Marshall 3 × 3 · Coordonnées : centre · Monde 1000 × 1000", "Base 3 × 3 · Marshall 3 × 3 · Coordenadas: centro · Mundo 1000 × 1000", "Base 3 × 3 · Marshall 3 × 3 · Coordenadas: centro · Mundo 1000 × 1000", "Căn cứ 3 × 3 · Marshall 3 × 3 · Tọa độ: tâm · Bản đồ 1000 × 1000", "기지 3 × 3 · Marshall 3 × 3 · 좌표: 중심 · 지도 1000 × 1000"]});
Object.assign(messages,{"Mittelpunkt der Auswahl": ["Selection center", "Centre de la sélection", "Centro de la selección", "Centro da seleção", "Tâm vùng chọn", "선택 영역 중심"], "Auswahl positionieren": ["Position selection", "Positionner la sélection", "Posicionar selección", "Posicionar seleção", "Đặt vị trí vùng chọn", "선택 영역 배치"], "Der Mittelpunkt des äußeren Rahmens wird positioniert. Alle markierten Objekte behalten ihre Abstände zueinander.": ["Positions the center of the outer bounding rectangle. All selected objects keep their distances from one another.", "Positionne le centre du rectangle englobant. Les objets sélectionnés conservent leurs distances entre eux.", "Posiciona el centro del rectángulo exterior. Los objetos seleccionados mantienen sus distancias entre sí.", "Posiciona o centro do retângulo externo. Os objetos selecionados mantêm suas distâncias entre si.", "Đặt tâm của khung chữ nhật bao ngoài. Mọi đối tượng được chọn giữ nguyên khoảng cách với nhau.", "바깥 경계 사각형의 중심을 배치합니다. 선택한 모든 물체의 간격은 유지됩니다."], "Alle Koordinaten bezeichnen den Mittelpunkt des Objekts. Verschieben verändert nur die gewählten Objekte. L4 zeigt 25 × 25 Felder je Beacon.": ["All coordinates refer to the object center. Moving affects only selected objects. L4 covers 25 × 25 tiles per beacon.", "Toutes les coordonnées désignent le centre de l’objet. Seuls les objets sélectionnés sont déplacés. L4 couvre 25 × 25 cases par balise.", "Las coordenadas indican el centro del objeto. Solo se mueven los objetos seleccionados. L4 cubre 25 × 25 casillas por baliza.", "As coordenadas indicam o centro do objeto. Apenas os objetos selecionados são movidos. L4 cobre 25 × 25 campos por beacon.", "Mọi tọa độ chỉ tâm đối tượng. Chỉ đối tượng được chọn mới di chuyển. L4 phủ 25 × 25 ô cho mỗi beacon.", "모든 좌표는 물체 중심을 나타냅니다. 선택한 물체만 이동합니다. L4는 비콘당 25 × 25칸을 덮습니다."], "Alle Koordinaten bezeichnen den Mittelpunkt des Objekts. Der Marshall bleibt der Bezugspunkt für Autofill.": ["All coordinates refer to the object center. Marshall remains the reference point for Autofill.", "Toutes les coordonnées désignent le centre de l’objet. Le Marshall reste le point de référence du remplissage automatique.", "Las coordenadas indican el centro del objeto. Marshall sigue siendo la referencia del llenado automático.", "As coordenadas indicam o centro do objeto. Marshall continua sendo a referência do preenchimento automático.", "Mọi tọa độ chỉ tâm đối tượng. Marshall vẫn là điểm tham chiếu cho Tự động điền.", "모든 좌표는 물체 중심을 나타냅니다. 자동 채우기의 기준점은 마샬입니다."]});
Object.assign(messages,{"Auswahlbereich": ["Selection scope", "Portée de la sélection", "Alcance de selección", "Âmbito da seleção", "Phạm vi chọn", "선택 범위"], "Aktuelle Allianz": ["Current alliance", "Alliance actuelle", "Alianza actual", "Aliança atual", "Liên minh hiện tại", "현재 연맹"], "Alle Allianzen": ["All alliances", "Toutes les alliances", "Todas las alianzas", "Todas as alianças", "Tất cả liên minh", "모든 연맹"], "{n} Objekte aus {alliances} Allianzen ausgewählt": ["{n} objects from {alliances} alliances selected", "{n} objets de {alliances} alliances sélectionnés", "{n} objetos de {alliances} alianzas seleccionados", "{n} objetos de {alliances} alianças selecionados", "Đã chọn {n} đối tượng từ {alliances} liên minh", "{alliances}개 연맹의 물체 {n}개 선택됨"]});
Object.assign(messages,{"Objekt gesperrt: {name}": ["Object locked: {name}", "Objet verrouillé : {name}", "Objeto bloqueado: {name}", "Objeto bloqueado: {name}", "Đối tượng bị khóa: {name}", "잠긴 물체: {name}"], "Ungültiger Baustein.": ["Invalid blueprint.", "Modèle invalide.", "Plantilla no válida.", "Modelo inválido.", "Mẫu không hợp lệ.", "잘못된 템플릿입니다."], "Mindestens zwei Objekte auswählen.": ["Select at least two objects.", "Sélectionnez au moins deux objets.", "Selecciona al menos dos objetos.", "Selecione pelo menos dois objetos.", "Chọn ít nhất hai đối tượng.", "물체를 두 개 이상 선택하세요."], "Zwei Basen derselben Allianz auswählen.": ["Select two bases of the same alliance.", "Sélectionnez deux bases de la même alliance.", "Selecciona dos bases de la misma alianza.", "Selecione duas bases da mesma aliança.", "Chọn hai căn cứ cùng liên minh.", "같은 연맹의 기지 두 개를 선택하세요."], "Spielerplätze tauschen": ["Swap players", "Échanger les joueurs", "Intercambiar jugadores", "Trocar jogadores", "Đổi chỗ người chơi", "플레이어 자리 교환"], "Spielerzuweisungen beider Basen tauschen?": ["Swap the players assigned to these bases?", "Échanger les joueurs affectés à ces bases ?", "¿Intercambiar los jugadores de estas bases?", "Trocar os jogadores destas bases?", "Đổi người chơi được gán cho hai căn cứ này?", "두 기지의 플레이어 배정을 교환할까요?"], "Auswahl kopiert. Spielerzuweisungen werden nicht kopiert.": ["Selection copied. Player assignments are not copied.", "Sélection copiée. Les affectations de joueurs ne sont pas copiées.", "Selección copiada. No se copian las asignaciones de jugadores.", "Seleção copiada. As atribuições de jogadores não são copiadas.", "Đã sao chép vùng chọn. Không sao chép phân chỗ người chơi.", "선택 영역을 복사했습니다. 플레이어 배정은 복사되지 않습니다."], "Zuerst eine Auswahl kopieren.": ["Copy a selection first.", "Copiez d’abord une sélection.", "Primero copia una selección.", "Copie uma seleção primeiro.", "Hãy sao chép vùng chọn trước.", "먼저 선택 영역을 복사하세요."], "Auf die Karte klicken, um die Kopie zu platzieren. Esc bricht ab.": ["Click the map to place the copy. Esc cancels.", "Cliquez sur la carte pour placer la copie. Échap annule.", "Haz clic en el mapa para colocar la copia. Esc cancela.", "Clique no mapa para posicionar a cópia. Esc cancela.", "Nhấp vào bản đồ để đặt bản sao. Esc để hủy.", "지도를 클릭해 복사본을 배치하세요. Esc로 취소합니다."], "Kopie platziert.": ["Copy placed.", "Copie placée.", "Copia colocada.", "Cópia posicionada.", "Đã đặt bản sao.", "복사본을 배치했습니다."], "Vorschau bereit. Mit Übernehmen bestätigen.": ["Preview ready. Confirm with Apply.", "Aperçu prêt. Confirmez avec Appliquer.", "Vista previa lista. Confirma con Aplicar.", "Prévia pronta. Confirme com Aplicar.", "Xem trước đã sẵn sàng. Xác nhận bằng Áp dụng.", "미리보기 준비 완료. 적용을 눌러 확인하세요."], "Arbeitsstand in diesem Browser gesichert.": ["Work saved in this browser.", "Travail sauvegardé dans ce navigateur.", "Trabajo guardado en este navegador.", "Trabalho salvo neste navegador.", "Đã lưu công việc trong trình duyệt này.", "이 브라우저에 작업을 저장했습니다."], "Automatische Sicherung nicht möglich. Bitte Plan als Datei speichern.": ["Automatic backup unavailable. Save the plan as a file.", "Sauvegarde automatique indisponible. Enregistrez le plan dans un fichier.", "No se puede guardar automáticamente. Guarda el plano como archivo.", "Backup automático indisponível. Salve o plano como arquivo.", "Không thể tự động sao lưu. Hãy lưu bản thiết kế thành tệp.", "자동 백업이 불가능합니다. 배치를 파일로 저장하세요."], "Letzter Arbeitsstand wiederhergestellt.": ["Last work session restored.", "Dernier travail restauré.", "Último trabajo restaurado.", "Último trabalho restaurado.", "Đã khôi phục công việc gần nhất.", "마지막 작업을 복원했습니다."], "Automatische Sicherung konnte nicht geladen werden.": ["Automatic backup could not be loaded.", "Impossible de charger la sauvegarde automatique.", "No se pudo cargar la copia automática.", "Não foi possível carregar o backup automático.", "Không thể tải bản sao lưu tự động.", "자동 백업을 불러올 수 없습니다."], "Auswählen": ["Select", "Sélectionner", "Seleccionar", "Selecionar", "Chọn", "선택"], "Ausgeblendet": ["Hidden", "Masqué", "Oculto", "Oculto", "Đã ẩn", "숨김"], "Umbenennen": ["Rename", "Renommer", "Renombrar", "Renomear", "Đổi tên", "이름 변경"], "Keine Treffer.": ["No matches.", "Aucun résultat.", "Sin resultados.", "Nenhum resultado.", "Không có kết quả.", "검색 결과가 없습니다."], "Gruppe auflösen": ["Ungroup", "Dissocier le groupe", "Desagrupar", "Desagrupar", "Bỏ nhóm", "그룹 해제"], "Noch keine Objektgruppen.": ["No object groups yet.", "Aucun groupe d’objets.", "Aún no hay grupos de objetos.", "Ainda não há grupos de objetos.", "Chưa có nhóm đối tượng.", "물체 그룹이 없습니다."], "Entfernen": ["Remove", "Supprimer", "Eliminar", "Remover", "Xóa", "제거"], "Noch keine Bausteine.": ["No blueprints yet.", "Aucun modèle enregistré.", "Aún no hay plantillas.", "Ainda não há modelos.", "Chưa có mẫu.", "템플릿이 없습니다."], "Freie 3×3-Positionen: {n}": ["Free 3×3 positions: {n}", "Positions 3×3 libres : {n}", "Posiciones 3×3 libres: {n}", "Posições 3×3 livres: {n}", "Vị trí 3×3 trống: {n}", "빈 3×3 위치: {n}"], "Erste 200 Positionen angezeigt.": ["First 200 positions shown.", "Affichage des 200 premières positions.", "Se muestran las primeras 200 posiciones.", "Exibindo as primeiras 200 posições.", "Hiển thị 200 vị trí đầu tiên.", "처음 200개 위치를 표시합니다."], "Landeflächen": ["Landing spaces", "Zones d’atterrissage", "Espacios de aterrizaje", "Espaços de pouso", "Vị trí đáp", "착륙 공간"], "Spieler ohne Platz": ["Unassigned players", "Joueurs sans place", "Jugadores sin puesto", "Jogadores sem lugar", "Người chơi chưa có chỗ", "미배정 플레이어"], "Vollständig im Licht": ["Fully covered by light", "Entièrement éclairé", "Totalmente cubierto por luz", "Totalmente coberto pela luz", "Được chiếu sáng toàn bộ", "빛에 완전히 포함"], "Teilweise im Licht": ["Partially covered by light", "Partiellement éclairé", "Parcialmente cubierto por luz", "Parcialmente coberto pela luz", "Được chiếu sáng một phần", "빛에 일부 포함"], "Außerhalb des Lichts": ["Outside light coverage", "Hors de portée de la lumière", "Fuera del alcance de la luz", "Fora do alcance da luz", "Ngoài phạm vi ánh sáng", "빛 범위 밖"], "Auswahlaktionen": ["Selection actions", "Actions de sélection", "Acciones de selección", "Ações da seleção", "Thao tác vùng chọn", "선택 작업"], "Sperren": ["Lock", "Verrouiller", "Bloquear", "Bloquear", "Khóa", "잠금"], "Entsperren": ["Unlock", "Déverrouiller", "Desbloquear", "Desbloquear", "Mở khóa", "잠금 해제"], "Kopieren": ["Copy", "Copier", "Copiar", "Copiar", "Sao chép", "복사"], "Einfügen": ["Paste", "Coller", "Pegar", "Colar", "Dán", "붙여넣기"], "Duplizieren": ["Duplicate", "Dupliquer", "Duplicar", "Duplicar", "Nhân bản", "복제"], "Kopien zuordnen": ["Assign copies to", "Affecter les copies à", "Asignar copias a", "Atribuir cópias a", "Gán bản sao cho", "복사본 연맹 지정"], "Allianzen beibehalten": ["Keep alliances", "Conserver les alliances", "Mantener alianzas", "Manter alianças", "Giữ nguyên liên minh", "연맹 유지"], "Kopien enthalten keine Spielerzuweisungen. Zentrum und Marshall: höchstens eines je Allianz.": ["Copies contain no player assignments. Center and Marshall: at most one each per alliance.", "Les copies ne contiennent aucune affectation de joueur. Centre et Marshall : un de chaque par alliance au maximum.", "Las copias no contienen asignaciones de jugadores. Centro y Marshall: como máximo uno de cada por alianza.", "As cópias não contêm atribuições de jogadores. Centro e Marshall: no máximo um de cada por aliança.", "Bản sao không chứa phân chỗ người chơi. Mỗi liên minh tối đa một trung tâm và một Marshall.", "복사본에는 플레이어 배정이 없습니다. 연맹마다 센터와 마샬은 각각 최대 하나입니다."], "Ausrichten und verteilen": ["Align and distribute", "Aligner et répartir", "Alinear y distribuir", "Alinhar e distribuir", "Căn chỉnh và phân bố", "정렬 및 배치"], "Horizontale Reihe": ["Horizontal row", "Rangée horizontale", "Fila horizontal", "Linha horizontal", "Hàng ngang", "가로 줄"], "Vertikale Reihe": ["Vertical column", "Colonne verticale", "Columna vertical", "Coluna vertical", "Hàng dọc", "세로 줄"], "Gleiche X-Koordinate": ["Same X coordinate", "Même coordonnée X", "Misma coordenada X", "Mesma coordenada X", "Cùng tọa độ X", "동일 X 좌표"], "Gleiche Y-Koordinate": ["Same Y coordinate", "Même coordonnée Y", "Misma coordenada Y", "Mesma coordenada Y", "Cùng tọa độ Y", "동일 Y 좌표"], "Abstand zwischen Außenkanten": ["Gap between outer edges", "Écart entre les bords", "Espacio entre bordes exteriores", "Espaço entre bordas externas", "Khoảng cách giữa các mép ngoài", "바깥 가장자리 간격"], "Vorschau": ["Preview", "Aperçu", "Vista previa", "Prévia", "Xem trước", "미리보기"], "Objektübersicht und Suche": ["Objects and search", "Objets et recherche", "Objetos y búsqueda", "Objetos e busca", "Đối tượng và tìm kiếm", "물체 목록 및 검색"], "Spieler oder Objekt suchen": ["Search player or object", "Rechercher un joueur ou objet", "Buscar jugador u objeto", "Buscar jogador ou objeto", "Tìm người chơi hoặc đối tượng", "플레이어 또는 물체 검색"], "Koordinaten anspringen": ["Go to coordinates", "Aller aux coordonnées", "Ir a coordenadas", "Ir para coordenadas", "Đến tọa độ", "좌표로 이동"], "Anzeigen": ["Show", "Afficher", "Mostrar", "Mostrar", "Hiển thị", "표시"], "Anzeige": ["Display", "Affichage", "Visualización", "Exibição", "Hiển thị", "화면 표시"], "Namen anzeigen": ["Show names", "Afficher les noms", "Mostrar nombres", "Mostrar nomes", "Hiện tên", "이름 표시"], "Koordinaten anzeigen": ["Show coordinates", "Afficher les coordonnées", "Mostrar coordenadas", "Mostrar coordenadas", "Hiện tọa độ", "좌표 표시"], "Notizen anzeigen": ["Show notes", "Afficher les notes", "Mostrar notas", "Mostrar notas", "Hiện ghi chú", "메모 표시"], "Raketenflächen anzeigen": ["Show missile areas", "Afficher les zones de missile", "Mostrar áreas de misiles", "Mostrar áreas de mísseis", "Hiện vùng tên lửa", "미사일 영역 표시"], "Notizen exportieren": ["Export notes", "Exporter les notes", "Exportar notas", "Exportar notas", "Xuất ghi chú", "메모 내보내기"], "Ausgeblendete Objekte blockieren weiterhin. Anzeige gilt auch für Viewer und Bildexport.": ["Hidden objects still block placement. Display settings also apply to the viewer and image export.", "Les objets masqués bloquent toujours le placement. L’affichage s’applique aussi à la vue partagée et aux images exportées.", "Los objetos ocultos siguen bloqueando la colocación. La visualización también se aplica al visor y a las imágenes exportadas.", "Objetos ocultos continuam bloqueando o posicionamento. A exibição também vale para o visualizador e imagens exportadas.", "Đối tượng bị ẩn vẫn chặn vị trí. Cài đặt hiển thị cũng áp dụng cho trình xem và ảnh xuất.", "숨긴 물체도 배치를 막습니다. 표시 설정은 뷰어와 이미지 내보내기에도 적용됩니다."], "Objektgruppen": ["Object groups", "Groupes d’objets", "Grupos de objetos", "Grupos de objetos", "Nhóm đối tượng", "물체 그룹"], "Auswahl als Objektgruppe speichern": ["Save selection as object group", "Enregistrer la sélection comme groupe", "Guardar selección como grupo", "Salvar seleção como grupo", "Lưu vùng chọn thành nhóm", "선택 영역을 물체 그룹으로 저장"], "Bausteine": ["Blueprints", "Modèles", "Plantillas", "Modelos", "Mẫu", "템플릿"], "Auswahl als Baustein speichern": ["Save selection as blueprint", "Enregistrer la sélection comme modèle", "Guardar selección como plantilla", "Salvar seleção como modelo", "Lưu vùng chọn thành mẫu", "선택 영역을 템플릿으로 저장"], "Bausteine exportieren": ["Export blueprints", "Exporter les modèles", "Exportar plantillas", "Exportar modelos", "Xuất mẫu", "템플릿 내보내기"], "Bausteine importieren": ["Import blueprints", "Importer les modèles", "Importar plantillas", "Importar modelos", "Nhập mẫu", "템플릿 가져오기"], "Bausteine werden mit dem Plan gespeichert. Export und Import übertragen sie in andere Karten.": ["Blueprints are saved with the plan. Export and import transfer them to other maps.", "Les modèles sont enregistrés avec le plan. L’export et l’import permettent de les transférer vers d’autres cartes.", "Las plantillas se guardan con el plano. Exporta e importa para transferirlas a otros mapas.", "Os modelos são salvos com o plano. Exporte e importe para transferi-los para outros mapas.", "Mẫu được lưu cùng bản thiết kế. Xuất và nhập để chuyển sang bản đồ khác.", "템플릿은 배치와 함께 저장됩니다. 내보내기와 가져오기로 다른 지도에 옮길 수 있습니다."], "Hive prüfen": ["Check hive", "Vérifier le hive", "Revisar hive", "Verificar hive", "Kiểm tra hive", "하이브 검사"], "Prüfbereich zeichnen": ["Draw check area", "Tracer la zone à vérifier", "Dibujar área de revisión", "Desenhar área de verificação", "Vẽ vùng kiểm tra", "검사 영역 그리기"], "Auswahl als Prüfbereich": ["Use selection as check area", "Utiliser la sélection comme zone", "Usar selección como área", "Usar seleção como área", "Dùng vùng chọn để kiểm tra", "선택 영역 검사"], "Prüfung starten": ["Run checks", "Lancer la vérification", "Iniciar revisión", "Iniciar verificação", "Bắt đầu kiểm tra", "검사 시작"], "Markierungen entfernen": ["Clear markers", "Effacer les marques", "Borrar marcadores", "Limpar marcadores", "Xóa đánh dấu", "표시 지우기"], "Prüft freie 3×3-Flächen im gewählten Rechteck, Lichtabdeckung und Belegung aller Allianzen. Terrain und feste Kerne blockieren; Schlamm, Notizen und Raketenflächen nicht. Licht wird je Allianz geometrisch geprüft. Keine Prüfung weiterer Spielregeln.": ["Checks free 3×3 spaces in the chosen rectangle, light coverage and assignments for all alliances. Terrain and solid cores block; mud, notes and missile areas do not. Light is checked geometrically per alliance. Other game rules are not checked.", "Vérifie les espaces 3×3 libres du rectangle, la lumière et les affectations de toutes les alliances. Le terrain et les noyaux solides bloquent ; la boue, les notes et les missiles ne bloquent pas. La lumière est vérifiée géométriquement par alliance. Les autres règles du jeu ne sont pas vérifiées.", "Revisa espacios 3×3 libres en el rectángulo, luz y asignaciones de todas las alianzas. El terreno y los núcleos sólidos bloquean; el barro, las notas y los misiles no. La luz se calcula geométricamente por alianza. No se revisan otras reglas del juego.", "Verifica espaços 3×3 livres no retângulo, luz e atribuições de todas as alianças. Terrenos e núcleos sólidos bloqueiam; lama, notas e mísseis não. A luz é verificada geometricamente por aliança. Outras regras do jogo não são verificadas.", "Kiểm tra chỗ 3×3 trống trong hình chữ nhật, ánh sáng và phân chỗ của mọi liên minh. Địa hình và lõi cứng chặn; bùn, ghi chú và tên lửa không chặn. Ánh sáng được tính hình học theo liên minh. Không kiểm tra quy tắc trò chơi khác.", "선택한 사각형의 빈 3×3 공간, 모든 연맹의 빛 범위와 배정을 검사합니다. 지형과 고정 중심부는 막지만 진흙, 메모, 미사일 영역은 막지 않습니다. 빛은 연맹별로 기하학적으로 계산합니다. 다른 게임 규칙은 검사하지 않습니다."], "Name": ["Name", "Nom", "Nombre", "Nome", "Tên", "이름"], "Speichern": ["Save", "Enregistrer", "Guardar", "Salvar", "Lưu", "저장"], "Objektgruppe benennen": ["Name object group", "Nommer le groupe d’objets", "Nombrar grupo de objetos", "Nomear grupo de objetos", "Đặt tên nhóm đối tượng", "물체 그룹 이름 지정"], "Baustein benennen": ["Name blueprint", "Nommer le modèle", "Nombrar plantilla", "Nomear modelo", "Đặt tên mẫu", "템플릿 이름 지정"], "Maximal 30 Bausteine.": ["Maximum 30 blueprints.", "30 modèles maximum.", "Máximo 30 plantillas.", "Máximo de 30 modelos.", "Tối đa 30 mẫu.", "템플릿은 최대 30개입니다."], "Rechteck für die Prüfung aufziehen.": ["Draw a rectangle for the check.", "Tracez un rectangle pour la vérification.", "Dibuja un rectángulo para revisar.", "Desenhe um retângulo para verificar.", "Vẽ hình chữ nhật để kiểm tra.", "검사할 사각형을 그리세요."], "Notiz": ["Note", "Note", "Nota", "Nota", "Ghi chú", "메모"], "Objekttyp": ["Object type", "Type d’objet", "Tipo de objeto", "Tipo de objeto", "Loại đối tượng", "물체 유형"], "Alle Objekttypen": ["All object types", "Tous les types d’objets", "Todos los tipos de objetos", "Todos os tipos de objetos", "Mọi loại đối tượng", "모든 물체 유형"], "Basen": ["Bases", "Bases", "Bases", "Bases", "Căn cứ", "기지"], "Gebäude": ["Buildings", "Bâtiments", "Edificios", "Edifícios", "Công trình", "건물"], "Notizen": ["Notes", "Notes", "Notas", "Notas", "Ghi chú", "메모"], "Auf Auswahl zoomen": ["Zoom to selection", "Zoomer sur la sélection", "Acercar a selección", "Ampliar seleção", "Thu phóng vùng chọn", "선택 영역 확대"]});
Object.assign(messages,{"Pläne": ["Plans", "Plans", "Planes", "Planos", "Kế hoạch", "계획"], "Teilen & Export": ["Share & export", "Partager et exporter", "Compartir y exportar", "Compartilhar e exportar", "Chia sẻ và xuất", "공유 및 내보내기"], "Objekte": ["Objects", "Objets", "Objetos", "Objetos", "Đối tượng", "오브젝트"], "Auswahl": ["Selection", "Sélection", "Selección", "Seleção", "Lựa chọn", "선택"], "Position": ["Position", "Position", "Posición", "Posição", "Vị trí", "위치"], "Eigenschaften": ["Properties", "Propriétés", "Propiedades", "Propriedades", "Thuộc tính", "속성"], "Aktionen": ["Actions", "Actions", "Acciones", "Ações", "Thao tác", "작업"], "Weitere Objekte": ["More objects", "Autres objets", "Más objetos", "Mais objetos", "Đối tượng khác", "기타 오브젝트"], "Keine Auswahl": ["Nothing selected", "Aucune sélection", "Sin selección", "Nenhuma seleção", "Chưa chọn đối tượng", "선택 없음"], "Änderungen werden direkt übernommen.": ["Changes apply immediately.", "Les modifications sont appliquées immédiatement.", "Los cambios se aplican de inmediato.", "As alterações são aplicadas imediatamente.", "Thay đổi được áp dụng ngay.", "변경 사항이 즉시 적용됩니다."], "Aktionen gelten für die aktuelle Auswahl.": ["Actions affect the current selection.", "Les actions concernent la sélection actuelle.", "Las acciones afectan a la selección actual.", "As ações afetam a seleção atual.", "Thao tác áp dụng cho lựa chọn hiện tại.", "작업은 현재 선택 항목에 적용됩니다."], "Koordinaten bezeichnen den Mittelpunkt.": ["Coordinates indicate the center.", "Les coordonnées indiquent le centre.", "Las coordenadas indican el centro.", "As coordenadas indicam o centro.", "Tọa độ biểu thị tâm.", "좌표는 중심을 나타냅니다."]});
Object.assign(messages,{"Optionen":["Options","Options","Opciones","Opções","Tùy chọn","옵션"],"Spieler verwalten":["Manage players","Gérer les joueurs","Gestionar jugadores","Gerenciar jogadores","Quản lý người chơi","플레이어 관리"]});
Object.assign(messages,{"Neuer Plan": ["New plan", "Nouveau plan", "Nuevo plano", "Novo plano", "Kế hoạch mới", "새 계획"], "Neuen Plan erstellen?": ["Create a new plan?", "Créer un nouveau plan ?", "¿Crear un nuevo plano?", "Criar um novo plano?", "Tạo kế hoạch mới?", "새 계획을 만들까요?"], "Speichere deinen aktuellen Plan zuerst. Eine neue leere Karte wird geöffnet.": ["Save your current plan first. A new empty map will open.", "Enregistrez d’abord votre plan actuel. Une nouvelle carte vide sera ouverte.", "Guarda primero tu plano actual. Se abrirá un nuevo mapa vacío.", "Salve seu plano atual primeiro. Um novo mapa vazio será aberto.", "Hãy lưu kế hoạch hiện tại trước. Một bản đồ trống mới sẽ mở.", "먼저 현재 계획을 저장하세요. 새로운 빈 지도가 열립니다."]});
let language='de';
